  ...
  return (
    <div className='hidden lg:flex gap-x-8 items-center'>
      <Link href='/' className='flex space-x-2'>
        ...
        <span className='hidden font-bold lg:inline-block'>FT</span>
                ...
                <li className='row-span-3'>
                  <NavigationMenuLink asChild>
                    <Link className='flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-none focus:shadow-md' href='/'>
                      ...
                      <div className='mb-2 mt-4 text-lg font-medium'>FT</div>
                      <p className='text-sm leading-tight text-muted-foreground'>This is a sample website built with the Next.js technology</p>
                    </Link>
                  </NavigationMenuLink>
                </li>
